...
get_rectangle_vertices(double x, double y, double theta, double width, double height) {
...
int main() {
  ...
  std::vector<double> i_log(sim_len), t_log(sim_len), x_log(sim_len), y_log(sim_len),
      theta_log(sim_len), v_log(sim_len), omega_log(sim_len), dt_log(sim_len);
